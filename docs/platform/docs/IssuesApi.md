...
public class Example {
  public static void main(String[] args) {
    ...
    IssuesApi apiInstance = new IssuesApi(defaultClient);
    BulkFetchIssueRequestBean bulkFetchIssueRequestBean = new BulkFetchIssueRequestBean(); // BulkFetchIssueRequestBean | A JSON object containing the information about which issues and fields to fetch.
    try {
      BulkIssueResults result = apiInstance.bulkFetchIssues(bulkFetchIssueRequestBean);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    IssuesApi apiInstance = new IssuesApi(defaultClient);
    BulkChangelogRequestBean bulkChangelogRequestBean = new BulkChangelogRequestBean(); // BulkChangelogRequestBean | A JSON object containing the bulk fetch changelog request filters such as issue IDs and field IDs.
    try {
      BulkChangelogResponseBean result = apiInstance.getBulkChangelogs(bulkChangelogRequestBean);
      System.out.println(result);
    } catch (ApiException e) {
