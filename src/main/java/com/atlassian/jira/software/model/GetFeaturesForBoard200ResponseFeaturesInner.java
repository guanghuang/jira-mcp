...
public class GetFeaturesForBoard200ResponseFeaturesInner {
  /**
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner() {
  }

  public GetFeaturesForBoard200ResponseFeaturesInner boardFeature(@javax.annotation.Nullable BoardFeatureEnum boardFeature) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner boardId(@javax.annotation.Nullable Long boardId) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner featureId(@javax.annotation.Nullable String featureId) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner featureType(@javax.annotation.Nullable FeatureTypeEnum featureType) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner imageUri(@javax.annotation.Nullable String imageUri) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner learnMoreArticleId(@javax.annotation.Nullable String learnMoreArticleId) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner learnMoreLink(@javax.annotation.Nullable String learnMoreLink) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner localisedDescription(@javax.annotation.Nullable String localisedDescription) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner localisedGroup(@javax.annotation.Nullable String localisedGroup) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner localisedName(@javax.annotation.Nullable String localisedName) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner permissibleEstimationTypes(@javax.annotation.Nullable List<GetFeaturesForBoard200ResponseFeaturesInnerPermissibleEstimationTypesInner> permissibleEstimationTypes) {
    this.permissibleEstimationTypes = permissibleEstimationTypes;
    return this;
  }

  public GetFeaturesForBoard200ResponseFeaturesInner addPermissibleEstimationTypesItem(GetFeaturesForBoard200ResponseFeaturesInnerPermissibleEstimationTypesInner permissibleEstimationTypesItem) {
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner state(@javax.annotation.Nullable StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public GetFeaturesForBoard200ResponseFeaturesInner toggleLocked(@javax.annotation.Nullable Boolean toggleLocked) {
  ...
  public boolean equals(Object o) {
    ...
    GetFeaturesForBoard200ResponseFeaturesInner getFeaturesForBoard200ResponseFeaturesInner = (GetFeaturesForBoard200ResponseFeaturesInner) o;
    return Objects.equals(this.boardFeature, getFeaturesForBoard200ResponseFeaturesInner.boardFeature) &&
        Objects.equals(this.boardId, getFeaturesForBoard200ResponseFeaturesInner.boardId) &&
        Objects.equals(this.featureId, getFeaturesForBoard200ResponseFeaturesInner.featureId) &&
        Objects.equals(this.featureType, getFeaturesForBoard200ResponseFeaturesInner.featureType) &&
        Objects.equals(this.imageUri, getFeaturesForBoard200ResponseFeaturesInner.imageUri) &&
        Objects.equals(this.learnMoreArticleId, getFeaturesForBoard200ResponseFeaturesInner.learnMoreArticleId) &&
        Objects.equals(this.learnMoreLink, getFeaturesForBoard200ResponseFeaturesInner.learnMoreLink) &&
        Objects.equals(this.localisedDescription, getFeaturesForBoard200ResponseFeaturesInner.localisedDescription) &&
        Objects.equals(this.localisedGroup, getFeaturesForBoard200ResponseFeaturesInner.localisedGroup) &&
        Objects.equals(this.localisedName, getFeaturesForBoard200ResponseFeaturesInner.localisedName) &&
        Objects.equals(this.permissibleEstimationTypes, getFeaturesForBoard200ResponseFeaturesInner.permissibleEstimationTypes) &&
        Objects.equals(this.state, getFeaturesForBoard200ResponseFeaturesInner.state) &&
        Objects.equals(this.toggleLocked, getFeaturesForBoard200ResponseFeaturesInner.toggleLocked);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFeaturesForBoard200ResponseFeaturesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFeaturesForBoard200ResponseFeaturesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFeaturesForBoard200ResponseFeaturesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFeaturesForBoard200ResponseFeaturesInner is not found in the empty JSON string", GetFeaturesForBoard200ResponseFeaturesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFeaturesForBoard200ResponseFeaturesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFeaturesForBoard200ResponseFeaturesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFeaturesForBoard200ResponseFeaturesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFeaturesForBoard200ResponseFeaturesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFeaturesForBoard200ResponseFeaturesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFeaturesForBoard200ResponseFeaturesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFeaturesForBoard200ResponseFeaturesInner>() {
           @Override
           public void write(JsonWriter out, GetFeaturesForBoard200ResponseFeaturesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFeaturesForBoard200ResponseFeaturesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFeaturesForBoard200ResponseFeaturesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFeaturesForBoard200ResponseFeaturesInner
   * @throws IOException if the JSON string is invalid with respect to GetFeaturesForBoard200ResponseFeaturesInner
   */
  public static GetFeaturesForBoard200ResponseFeaturesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeaturesForBoard200ResponseFeaturesInner.class);
  }

  /**
   * Convert an instance of GetFeaturesForBoard200ResponseFeaturesInner to an JSON string
   *
   * @return JSON string
   */
