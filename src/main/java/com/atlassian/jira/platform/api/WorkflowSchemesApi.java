...
import com.atlassian.jira.platform.model.DefaultWorkflow;
import com.atlassian.jira.platform.model.IssueTypeWorkflowMapping;
import com.atlassian.jira.platform.model.IssueTypesWorkflowMapping;
import com.atlassian.jira.platform.model.PageBeanWorkflowScheme;
import com.atlassian.jira.platform.model.TaskProgressBeanObject;
import com.atlassian.jira.platform.model.WorkflowScheme;
import com.atlassian.jira.platform.model.WorkflowSchemeProjectUsageDTO;
import com.atlassian.jira.platform.model.WorkflowSchemeReadRequest;
import com.atlassian.jira.platform.model.WorkflowSchemeReadResponse;
import com.atlassian.jira.platform.model.WorkflowSchemeUpdateRequest;
import com.atlassian.jira.platform.model.WorkflowSchemeUpdateRequiredMappingsRequest;
import com.atlassian.jira.platform.model.WorkflowSchemeUpdateRequiredMappingsResponse;
...
public class WorkflowSchemesApi {
     ...
     */
    public okhttp3.Call getProjectUsagesForWorkflowSchemeCall(String workflowSchemeId, String nextPageToken, Integer maxResults, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectUsagesForWorkflowSchemeValidateBeforeCall(String workflowSchemeId, String nextPageToken, Integer maxResults, final ApiCallback _callback) throws ApiException {
     ...
     */
    public WorkflowSchemeProjectUsageDTO getProjectUsagesForWorkflowScheme(String workflowSchemeId, String nextPageToken, Integer maxResults) throws ApiException {
     ...
     */
    public ApiResponse<WorkflowSchemeProjectUsageDTO> getProjectUsagesForWorkflowSchemeWithHttpInfo(String workflowSchemeId, String nextPageToken, Integer maxResults) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectUsagesForWorkflowSchemeAsync(String workflowSchemeId, String nextPageToken, Integer maxResults, final ApiCallback<WorkflowSchemeProjectUsageDTO> _callback) throws ApiException {
