...
import com.atlassian.jira.platform.model.CustomFieldDefinitionJsonBean;
import com.atlassian.jira.platform.model.ErrorCollection;
import com.atlassian.jira.platform.model.FieldDetails;
import com.atlassian.jira.platform.model.PageBeanContext;
import com.atlassian.jira.platform.model.PageBeanField;
import java.util.Set;
import com.atlassian.jira.platform.model.TaskProgressBeanObject;
import com.atlassian.jira.platform.model.UpdateCustomFieldDetails;
...
public class IssueFieldsApi {
     ...
     */
    public okhttp3.Call getFieldsPaginatedCall(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, Set<Long> projectIds, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFieldsPaginatedValidateBeforeCall(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, Set<Long> projectIds, final ApiCallback _callback) throws ApiException {
     ...
     */
    public PageBeanField getFieldsPaginated(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, Set<Long> projectIds) throws ApiException {
     ...
     */
    public ApiResponse<PageBeanField> getFieldsPaginatedWithHttpInfo(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, Set<Long> projectIds) throws ApiException {
     ...
     */
    public okhttp3.Call getFieldsPaginatedAsync(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, Set<Long> projectIds, final ApiCallback<PageBeanField> _callback) throws ApiException {
