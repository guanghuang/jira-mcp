...
import com.atlassian.jira.platform.model.ChangedWorklogs;
import com.atlassian.jira.platform.model.PageOfWorklogs;
import com.atlassian.jira.platform.model.Worklog;
import com.atlassian.jira.platform.model.WorklogIdsRequestBean;
import com.atlassian.jira.platform.model.WorklogsMoveRequestBean;
...
public class IssueWorklogsApi {
     ...
     */
    public okhttp3.Call bulkDeleteWorklogsCall(String issueIdOrKey, WorklogIdsRequestBean worklogIdsRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bulkDeleteWorklogsValidateBeforeCall(String issueIdOrKey, WorklogIdsRequestBean worklogIdsRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
     ...
     */
    public void bulkDeleteWorklogs(String issueIdOrKey, WorklogIdsRequestBean worklogIdsRequestBean, String adjustEstimate, Boolean overrideEditableFlag) throws ApiException {
     ...
     */
    public ApiResponse<Void> bulkDeleteWorklogsWithHttpInfo(String issueIdOrKey, WorklogIdsRequestBean worklogIdsRequestBean, String adjustEstimate, Boolean overrideEditableFlag) throws ApiException {
     ...
     */
    public okhttp3.Call bulkDeleteWorklogsAsync(String issueIdOrKey, WorklogIdsRequestBean worklogIdsRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call bulkMoveWorklogsCall(String issueIdOrKey, WorklogsMoveRequestBean worklogsMoveRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bulkMoveWorklogsValidateBeforeCall(String issueIdOrKey, WorklogsMoveRequestBean worklogsMoveRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
     ...
     */
    public void bulkMoveWorklogs(String issueIdOrKey, WorklogsMoveRequestBean worklogsMoveRequestBean, String adjustEstimate, Boolean overrideEditableFlag) throws ApiException {
     ...
     */
    public ApiResponse<Void> bulkMoveWorklogsWithHttpInfo(String issueIdOrKey, WorklogsMoveRequestBean worklogsMoveRequestBean, String adjustEstimate, Boolean overrideEditableFlag) throws ApiException {
     ...
     */
    public okhttp3.Call bulkMoveWorklogsAsync(String issueIdOrKey, WorklogsMoveRequestBean worklogsMoveRequestBean, String adjustEstimate, Boolean overrideEditableFlag, final ApiCallback<Void> _callback) throws ApiException {
