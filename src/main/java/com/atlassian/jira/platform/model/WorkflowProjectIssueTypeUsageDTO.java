...
import com.atlassian.jira.platform.model.WorkflowProjectIssueTypeUsagePage;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowProjectIssueTypeUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowProjectIssueTypeUsageDTO is not found in the empty JSON string", WorkflowProjectIssueTypeUsageDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowProjectIssueTypeUsageDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowProjectIssueTypeUsageDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
