...
import com.atlassian.jira.platform.model.FieldIdentifierObject;
...
public class FieldAssociationsRequest {
  ...
  static {
    ...
    openapiFields.add("associationContexts");
    openapiFields.add("fields");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("associationContexts");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FieldAssociationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldAssociationsRequest is not found in the empty JSON string", FieldAssociationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FieldAssociationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldAssociationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("associationContexts").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `associationContexts` to be an array in the JSON string but got `%s`", jsonObj.get("associationContexts").toString()));
      }
