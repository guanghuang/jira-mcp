...
public class BulkFetchIssueRequestBean {
  ...
  static {
    ...
    openapiRequiredFields.add("issueIdsOrKeys");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkFetchIssueRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BulkFetchIssueRequestBean is not found in the empty JSON string", BulkFetchIssueRequestBean.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkFetchIssueRequestBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BulkFetchIssueRequestBean` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
