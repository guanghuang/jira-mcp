...
import com.atlassian.jira.platform.model.GetDateFieldResponse;
...
public class GetSchedulingResponse {
  ...
  static {
    ...
    openapiRequiredFields.add("inferredDates");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSchedulingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSchedulingResponse is not found in the empty JSON string", GetSchedulingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSchedulingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSchedulingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
