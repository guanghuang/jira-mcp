...
public class JiraSoftwareMCPService {
    ...
    public GetAllBoards200Response getAllBoards(@ToolArg(required = false, description = "Filters results to boards that match or partially match the specified name.") String name,
        ...
        return new BoardApi(apiClient).getAllBoards(startAt == null ? null : startAt.longValue(), maxResults, type, name, projectKeyOrId, null, null, null, null, null, null, null, null);
    }
    ...
    public SearchResults getIssuesFromBoard(@ToolArg(description = "The ID of the jira board.") Integer boardId,
        ...
        return new BoardApi(apiClient).getIssuesForBoard(boardId == null ? null : boardId.longValue(), startAt == null ? null : startAt.longValue(), maxResults, jql, null, getFieldsList(fields), null);
    }
    ...
    public GetAllSprints200Response getSprintsFromBoard(@ToolArg(description = "The ID of the jira board.") Integer boardId,
        ...
        return new BoardApi(apiClient).getAllSprints(boardId == null ? null : boardId.longValue(), startAt == null ? null : startAt.longValue(), maxResults, state);
    }
    ...
    public SearchResults getIssuesFromSprint(@ToolArg(description = "The ID of the jira board.") Integer boardId,
        ...
        @ToolArg(required = false, description = "The maximum number of issues to return. Default is 50.") Integer maxResults,
        @ToolArg(required = false, description = "The starting index of the returned issues. Base index: 0. Default is 0.") Integer startAt) throws ApiException {
        return new BoardApi(apiClient).getBoardIssuesForSprint(boardId == null ? null : boardId.longValue(), sprintId == null ? null : sprintId.longValue(), startAt == null ? null : startAt.longValue(), maxResults, jql, null, getFieldsList(fields), null);
    }
    ...
    public SearchResults getIssuesFromEpic(@ToolArg(description = "The ID of the jira board.") Integer boardId,
        ...
        @ToolArg(required = false, description = "The maximum number of issues to return. Default is 50.") Integer maxResults,
        @ToolArg(required = false, description = "The starting index of the returned issues. Base index: 0. Default is 0.") Integer startAt) throws ApiException {
        return new BoardApi(apiClient).getBoardIssuesForEpic(boardId == null ? null : boardId.longValue(), epicId == null ? null : epicId.longValue(), startAt == null ? null : startAt.longValue(), maxResults, jql, null, getFieldsList(fields), null);
    }
